...
Usar `forEach()` não será útil se você quise4r modificar permanentemente a array original. forEach() sempre retorna `undefined`. Contudo, criar uma nova array a partir de uma array existente é simples, com o poderoso método `map()`.
